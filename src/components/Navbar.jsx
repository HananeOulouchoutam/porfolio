    ...
    <nav className="fixed w-full z-50 bg-dark-100/90 backdrop-blur-sm py-4 px-8 shadow-lg">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex ">
          <a
            href="#home"
            className="relative text-white/80 transition duration-300  px-6 py-2 hover:text-purple group"
          >
            <span>Home</span>
          ...
          <a
            href="#contact"
            className="relative text-white/80 px-6 py-2 bg-purple-600 rounded-full 
