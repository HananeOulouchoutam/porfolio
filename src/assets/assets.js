...
export const aboutInfo = [
  {
    icon: FaLightbulb,
    title: "Innovative",
    description: "I create smart solutions using modern technologies.",
    color: "text-purple",
  },
  {
    icon: FaPaintBrush,
    title: "Design Oriented",
    description: "I focus on clean, user-friendly design.",
    color: "text-pink",
  },
  {
    icon: FaCode,
    title: "Clean Code",
    description: "I write simple, efficient, and maintainable code.",
    color: "text-blue",
  },
];
